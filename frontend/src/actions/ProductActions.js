...
export const updateProduct = (id, productData) => async (dispatch) => {
  try {
    ...
    console.log("prodjhb data ",productData);
...
export const getVariants= (name) => async (dispatch)=>{
     try{
      ...
      dispatch({
                type:ALL_VARIANT_FAIL,
                payload: error.message,
            })
        console.log("error while getting variants ", error.message);
     }
}; 
