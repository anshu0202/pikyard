          ...
          <div className="ProductDetails">
            ...
            <div className="varse__2">
              ...
              <div className="detailsBlock">
                ...
                >
                  {variants?.length > 1 && <h1>{`₹${offerPrice}`}</h1>
                  }
                  {
                    product.offerPrice > 0 && offerPrice<price && <h1 className="discountPrice">
                      {product.offerPrice > 0 ? `₹${price}` : ""}
                    </h1>
                  }
                </div>
                ...
                <div className="variantList">
                  ...
                  >
                    {variants?.map((item, index) => {
                      return (
                        <option key={index} value={item?.mm} style={{ background: "#f1f1f1", color: "black"}}>
                          {item?.mm} mm
                        </option>
                      );
                    })}
